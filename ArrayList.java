...
public class ArrayList<T> {
    ...
    public void addAtIndex(int index, T data) {
        ...
        if (index < 0 || index > size) {
            throw new IndexOutOfBoundsException("The target index is out of the bound of the backingarray");
        }

        if (size + 1 > this.backingArray.length) {
            T[] newArr = (T[]) new Object[this.backingArray.length * 2];
    ...
    public static void main(String[] args) {
        ...
        haha.addAtIndex(0, 10);
        haha.addAtIndex(1, 7);
        haha.addAtIndex(2, 5);
        haha.addAtIndex(3, 8);
        //10 7 5 8

        haha.removeAtIndex(1);
        haha.addToFront(19);
        haha.addToBack(2);
        haha.addToBack(2);
        haha.addToBack(2);
